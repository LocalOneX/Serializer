...
function module.to_base64(data)
...
local header = table.concat({
   "--[=[",
   indent"@LocalOnex",
   indent"@repository: "..module.Repository,
   indent"@decumentation: https://raw.githubusercontent.com/LocalOneX/serializer/refs/heads/main/README.md"
}, "\n")
local EXECUTOR_NAME = (identifyexecutor or getexecutorname or whatexecutor or (function() return "ROBLOX" end))()
...
function module:lookup(class,...)
   ...
   local classFunction = self["s_"..class]
   if classFunction then
       return classFunction(self, ...) ---> self:"s_"..class(...)
   end
  
   return "nil --[=[Unsupported type:"..class.."]=]"
end
...
function module:s_Vector3(vector3:Vector3)
   ...
   return string.format("Vector3.new(%s, %s, %s)", vector3.X, vector3.Y, vector3.Z) 
end


function module:s_Vector2(vector2:Vector2)
   if vector2 == Vector2.one then
       return "Vector2.one"
   elseif vector2 == Vector2.zero then
       return "Vector2.zero"
   elseif vector2 == Vector2.xAxis then
       return "Vector2.xAxis"
   elseif vector2 == Vector2.yAxis then
       return "Vector2.yAxis"
   end
  
   return string.format("Vector2.new(%s, %s, %s)", vector2.X, vector2.Y, vector2.Z) 
end
